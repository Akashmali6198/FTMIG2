...
<div class="container">
    ...
    <div class="row">
        ...
        Investor Experience (IX) Platform - Ads
        </h1>
    ...
    <div class="row">
        <div class="col-sm-12"> 
               ...
               <h2>Advertising software suite</h2>

                    <p class="ix-multi-subline">
                    Where ads invite conversations
                   </p> 
       </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="row">
                  ...
                  <div class="col-12">
                         ...
                         <h5 class="ix-multi-title-small">Investor Network</h5>
                         <span class="exp-pts-line-white"></span>
                         <p class="ix-multi-subline-small">
                         Our machine learning algorithms will specifically match your Company’s marketing and advertising assets with best-fit investors</p>

                    </div><!--col--> 

                     <div class="col-12">

                         <h5 class="ix-multi-title-small">Distribution Channels</h5>
                         <span class="exp-pts-line-white"></span>
                         <p class="ix-multi-subline-small">
                         Your Company's ads will be featured across 1,000+ websites through display, social, search, and email advertising.</p>

                    </div><!--col--> 

                     <div class="col-12">

                         <h5 class="ix-multi-title-small">Designed for Outcomes</h5>
                         <span class="exp-pts-line-white"></span>
                         <p class="ix-multi-subline-small">
                         Bespoke advertising campaigns designed around your goals as an investor relations officer.</p>
    ...
    <div class="row multi-author-row"> 
        ...
        <div class="col-12 col-lg-8 rma-col">
               ...
               <div class="rmac-col-inner">
                       ...
                       FTMIG has a very innovative and cost effective approach to online advertising.</p>
                        ...
                        <div class="row inner-author-row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                         ...
                                         <div class="ix-multi-quote-img">
                                             <img src="https://149474761.v2.pressablecdn.com/wp-content/themes/six-usm/assets/img/ie-ix/ads/avatar.png" class="ix-multi-single-author"></noscript>
                                         </div><!--img-->

                                         <div class="ix-multi-author"> 
                                             <h4 class="ix-multi-quote-author">Martino de Ciccio</h4>
                                             <h5 class="ix-multi-quote-job">VP of Strategy and Investor Relations</h5> 
                                         </div><!--multi-author-->
